...
class __TwigTemplate_07c3fefe52f260fc8a0c34112b9444af extends Template
{
...
($context["items"] ?? null), "current", [], "any", false, false, true, 29), ));
      ...
      ";
          ...
          <a href=\"";
            ...
            <span aria-hidden=\"true\">";
                // line 37
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, true, true, 37), "text", [], "any", true, true, true, 37)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, true, true, 37), "text", [], "any", false, false, true, 37), t("››"))) : (t("››"))), "html", null, true);
                yield "</span>
          </a>
        </li>
      ";
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/views/views-mini-pager.html.twig", "/var/www/html/vehicle_app/themes/contrib/bootstrap5/templates/views/views-mini-pager.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("if" => 14, "trans" => 28);
        static $filters = array("escape" => 15, "t" => 16, "without" => 20, "default" => 22);
